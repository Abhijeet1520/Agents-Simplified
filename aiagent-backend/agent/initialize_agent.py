...
from agent.oneinch_actions.actions import fetch_active_orders, swap_tokens, fetch_quote
...
def initialize_agent():
    ...
    tools = cdp_toolkit.get_tools() + [get_latest_block, fetch_active_orders, swap_tokens, fetch_quote]
